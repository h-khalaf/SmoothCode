...
contactRouter.get('/contact', redirectToDashboardIfLoggedIn, (req, res) => {
    const model = { pageTitle: CONTACT_PAGE_TITLE }
    res.render('contact.hbs', model)
})

contactRouter.post('/contact', redirectToDashboardIfLoggedIn, contactValidation, async (req, res) => {
    const model  = { 
